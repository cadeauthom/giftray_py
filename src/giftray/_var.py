...
class trayconf:
    ...
    def load(self):
        ...
        if 'Generals' in config:
            if 'LogLevel' in config['Generals']:
            ...
            if 'Silent' in config['Generals']:
                self.conf['Generals']['Silent'] = config['Generals']['Silent']
            if 'Icons' in config['Generals']:
                for i in config['Generals']['Icons']:
                    if i in self.conf['Generals']['Icons']:
                        self.conf['Generals']['Icons'][i] = config['Generals']['Icons'][i]
            if 'Themes' in config['Generals']:
                for t in config['Generals']['Themes']:
                    if t in self.conf['Generals']['Themes']:
                        if 'Dark' in config['Generals']['Themes'][t]:
                            self.conf['Generals']['Themes'][t]['Dark'] = config['Generals']['Themes'][t]['Dark']
                        if 'Light' in config['Generals']['Themes'][t]:
                            self.conf['Generals']['Themes'][t]['Light'] = config['Generals']['Themes'][t]['Light']
                        if 'Theme'  in config['Generals']['Themes'][t]:
                            self.conf['Generals']['Themes'][t]['Theme'] = self.getTheme(config['Generals']['Themes'][t]['Theme'])
            for k in config['Generals']:
                if k in ['LogLevel', 'Silent', 'Icons' 'Theme']:
                    continue
